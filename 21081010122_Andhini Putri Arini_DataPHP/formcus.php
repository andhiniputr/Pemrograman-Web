    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:100px;">
              <li class="nav-item">
                <a class="nav-link" href="<?php echo "indexnew.php"; ?>">Data</a>
                <li class="nav-item">
                <a class="nav-link" href="<?php echo "formprod.php"; ?>">Tambah Data Product</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo "formcus.php"; ?>">Tambah Data Customer</a>
              </li>
            </ul>
          </div>
        </nav>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="formcus.php" method="POST">
